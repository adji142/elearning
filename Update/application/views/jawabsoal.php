              ...
              success: function (response) {
                ...
                $.each(response.data,function (k,v) {
                  ...
                  if ($('#loadtype').val() == 1) {
                    ...
                    imagefield = '<div class="form-group">'+
                                    '<label for="inputEmail1" class="col-lg-4 col-sm-4 control-label">Attachment</label>'+
                                    '<div class="col-lg-8">'+
                                      '<input type="file" id="Attachment" name="Attachment" accept=".jpg , .jpeg , .png" onChange="encodeImagetoBase64(this,'+x+')" />'+
                                      '<textarea id="Lampiran'+x+'" name="Lampiran'+x+'" style="display: none;"></textarea>'+
                                    '</div>'+
                                  '</div>'
                  }
                    ...
                    imagefield = '<div class="form-group">'+
                                    '<center><img src = "'+v.attachment+'" width = "20%" hight = "20%"></img></center>'+
                                '</div>';
                  }
                  ...
                  html += '<input type="hidden" name="soal'+x+'" id="soal'+x+'" value="'+v.id+'">'
                	html += '<div class="form-group">'+
                          ...
                          '</div>'+
                          '<div class="form-group">'+
                                  '<center><img src = "'+v.Image+'" width = "50%"></img></center>'+
                          '</div>'+
                          '<div class="form-group">'+
                    ...
                    $.each(response.data,function (k,v) {
                      console.log($('#jawab'+x).val());
                        $.ajax({
                          ...
                          data    : {'SoalID':v.id,'Jawaban':$('#jawab'+x).val(),'AnswerTime' : $('#timeticker').val(),'topikid':$('#topikid').val(),'Status':0,'Score':0,'attachment':$('#Lampiran'+x).val()},
                          dataType: 'json',
...
function encodeImagetoBase64(element,x) {
      $('#Lampiran'+x).val('');
